...
@Component({
  selector: "app-customer-stat-outstanding",
  templateUrl: "./customer-stat-outstanding.component.html",
  styleUrls: ["./customer-stat-outstanding.component.scss"],
})
export class CustomerStatOutstandingComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.casCustomerService
      .getCustomerAccountStatistic(this.customerDetails)
      .subscribe((res: any) => {
        if (!_.isEmpty(res)) {
