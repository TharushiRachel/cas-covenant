...
@Component({
  selector: 'app-bcc-existing-facilities',
  templateUrl: './bcc-existing-facilities.component.html',
  styleUrls: ['./bcc-existing-facilities.component.scss']
})
export class BccExistingFacilitiesComponent implements OnInit {

  @Input() existingFacilitiesGroup: FormGroup;
