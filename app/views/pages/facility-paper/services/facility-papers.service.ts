...
@Injectable()
export class FacilityPapersService implements Resolve<any> {
  ...
  searchFacilityPapers(searchData?, paginationData?: Pagination): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.dataService.postWithPageData(SETTINGS.ENDPOINTS.getPagedFacilityPaper, searchData, paginationData)
