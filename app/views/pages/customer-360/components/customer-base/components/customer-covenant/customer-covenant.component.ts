...
import { EditCustomerCovenantComponent } from "./edit-customer-covenant/edit-customer-covenant.component";
import { EditAccountCovenantComponent } from "../add-account-covenant/edit-account-covenant/edit-account-covenant.component";
...
export class CustomerCovenantComponent implements OnInit {
  ...
  openDialogForUpdateCustomerCovenant(customerCovenant: any, response?) {
    ...
    this.modalRef = this.mdbModalService.show(EditCustomerCovenantComponent, {
      backdrop: true,
      keyboard: true,
      focus: true,
      show: false,
  ...
  openDialogForUpdateAccountCovenant(facilityCovenant: any, response?) {
    ...
    this.modalRef = this.mdbModalService.show(EditAccountCovenantComponent, {
      backdrop: true,
      keyboard: true,
      focus: true,
      show: false,
