...
@Component({
  selector: 'app-apf-documents-preview',
  templateUrl: './apf-documents-preview.component.html',
  styleUrls: ['./apf-documents-preview.component.scss']
})
export class ApfDocumentsPreviewComponent implements OnInit, OnDestroy {
