...
@Component({
  selector: 'app-external-lead-decline',
  templateUrl: './external-lead-decline.component.html',
  styleUrls: ['./external-lead-decline.component.scss']
})
export class ExternalLeadDeclineComponent implements OnInit, OnDestroy {
  ...
  onDecline() {
    ...
    let data = {
      leadID: this.leadID,
      leadStatus: this.leadStatusConst.DECLINED,
      ...
      action: this.leadActionConst.DECLINED
    };
