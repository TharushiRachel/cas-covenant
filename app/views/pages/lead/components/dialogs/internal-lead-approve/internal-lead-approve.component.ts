...
@Component({
  selector: 'app-internal-lead-approve',
  templateUrl: './internal-lead-approve.component.html',
  styleUrls: ['./internal-lead-approve.component.scss']
})
export class InternalLeadApproveComponent implements OnInit, OnDestroy {
  ...
  createCommentForm() {
    return this.formBuilder.group({
      customerBankAccountNumber: ['', [Validators.required, Validators.maxLength(50)]],
