...
@Component({
  selector: 'committee-paper-count-box',
  templateUrl: './committee-paper-count-box.component.html',
  styleUrls: ['./committee-paper-count-box.component.scss']
})
export class CommitteePaperCountBoxComponent implements OnInit {
